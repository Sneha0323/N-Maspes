...
import { Col, Container, Row, Card, Image, Navbar, NavLink, Nav, Button, Overlay } from "react-bootstrap";
            ...
            <Container>
                ...
                <Row className="my-4 py-4 justify-content-md-between">
                    <Col md={4} sm={12} className="p-3">
                        ...
                        <Image src="https://maspes.io/static/media/footer-logo.b0c3459f5621fa49fca92030e4ab4efd.svg" className="d-block" />
                    </Col>
                    <Col md={2}>
                        <Navbar>
